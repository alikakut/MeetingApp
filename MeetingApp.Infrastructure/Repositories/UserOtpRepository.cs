...
namespace MeetingApp.Infrastructure.Repositories
{
    ...
    {
        public UserOtpRepository(MeetingAppDbContext context, BaseApplicationSieveProcessor<DataFilterModel, FilterTerm, SortTerm> sieveProcessor, IHttpContextAccessor httpContextAccessor, SessionManager sessionManager) : base(context, sieveProcessor, httpContextAccessor, sessionManager)
        {
        }
    }
}
